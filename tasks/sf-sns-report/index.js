...
const throwDisabledError = () => {
  throw new Error(
    ...
    + ' reporting SNS topic and any consumers to listen to it have been removed, this task has'
    + ' been disabled. Use @cumulus/sf-sqs-report for mid-workflow updates instead.'
  );
};
